...
function Items() {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      await axiosClient.delete(`/items/${deleteTarget.id}`);
      setDeleteTarget(null);
      fetchData();
    } catch (err) {
      setDeleteError("Failed to Delete this Item");
    } finally {
      setIsDeleting(false);
    }
  };
  ...
  // Tampilan ketika koneksi terputus / error di Items
  if (error) {
    return (
